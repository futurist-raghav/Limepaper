...
## 18.0.1 Quick Visual Index

| | | |
| :---: | :---: | :---: |
| <img src="images/skus/sheet-stock.png" width="150"><br>**Sheet/roll stock**<br>§18.1 — A0–A6, Letter/Legal | <img src="images/skus/notebook.png" width="150"><br>**Notebooks/stationery**<br>§18.2 | <img src="images/skus/carton.png" width="150"><br>**Cartons**<br>§18.4 — folding, rigid, corrugated, mono |
| <img src="images/skus/label-tag.png" width="150"><br>**Labels & tags**<br>§18.5 — adhesive labels, hang tags, signage | <img src="images/skus/wallpaper.png" width="150"><br>**Wallpaper**<br>§18.6 | <img src="images/skus/food-packaging.png" width="150"><br>**Food packaging**<br>§18.7 — bakery boxes, wraps |
| <img src="images/skus/mailer.png" width="150"><br>**E-commerce mailers**<br>§18.8 | <img src="images/skus/bag-carry-premium.png" width="150"><br>**Premium carry bags**<br>§18.9.2 — expansion horizon | <img src="images/skus/carton-rigid.png" width="150"><br>**Rigid box wrap/liner**<br>§18.9.3 — the decorative layer only |
...
| :---- | :---- | ----: | ----: | ----: | :---- |
| Hang tags, 40×80mm | §18.5 | ₹0.02 | ₹0.01 | **₹0.03** | ₹0.05 |
| Self-adhesive labels, 100×150mm | §18.5 | ₹0.03 | ₹0.02 | **₹0.05** | ₹0.06 |
| QSR wrap, 250×250mm | §18.7 | ₹0.06 | ₹0.04 | **₹0.10** | ₹0.13 |
| Bakery box liner, 200×300mm | §18.7 | ₹0.07 | ₹0.05 | **₹0.12** | ₹0.14 |
| Mailer envelope, 250×350mm | §18.8 | ₹0.20 | ₹0.14 | **₹0.34** | ₹0.40 |
| ID/access card, ID-1 | §18.5 | ₹0.20 | ₹0.14 | **₹0.34** | PVC card — not costed |
| Corrugated liner ply, 0.06 m² | §18.4.2 | ₹0.34 | ₹0.24 | **₹0.58** | ₹0.69 |
| Menu / placemat, A4 | §18.5 | ₹0.39 | ₹0.27 | **₹0.66** | ₹0.81 |
| Folding carton blank, 0.06 m² | §18.4.2 | ₹0.50 | ₹0.35 | **₹0.85** | ₹1.04 |
| Pharma mono-carton, 0.06 m² | §18.4.2 | ₹0.55 | ₹0.39 | **₹0.94** | ₹1.12 |
| Rigid box wrap + liner | §18.9.3 | ₹1.48 | ₹1.04 | **₹2.52** | ₹3.06 |
| Boutique bag, 180×230×90mm | §18.9.2 | ₹2.34 | ₹1.64 | **₹3.98** | ₹2.94 |
| Carry bag, 320×250×120mm | §18.9.2 | ₹4.23 | ₹2.00 *(capped)* | **₹6.23** | ₹5.33 |
| Bridal bag, 400×320×150mm | §18.9.2 | ₹6.55 | ₹2.00 *(capped)* | **₹8.55** | ₹8.25 |
...
| :---- | :---- | :---- | :---- |
| A0 | 841 × 1189 | 1.000 | Posters, technical drawings, outdoor signage backing |
| A1 | 594 × 841 | 0.500 | Posters, large-format signage |
| A2 | 420 × 594 | 0.250 | Posters, charts, large diaries |
| A3 | 297 × 420 | 0.125 | Drawing pads, large notebooks, folded brochures |
| A4 | 210 × 297 | 0.0625 | Copier/writing paper, notebook pages, letterheads — the reference size everyone asks about |
| A5 | 148 × 210 | 0.03125 | Notebooks, diaries, half-fold brochures |
| A6 | 105 × 148 | 0.015625 | Postcards, small notepads, index cards |
| Letter (US) | 216 × 279 | 0.0603 | US-market export SKUs |
| Legal (US) | 216 × 356 | 0.0769 | US-market export SKUs, legal documents |

### 18.1.2 A4 — the reference comparison, worked in full

*Standard copier/writing paper runs 70–80 GSM in India (JK Copier, Century, etc. — general market convention, not project-sourced). Stone paper's commercial equivalent for a comparable notebook/writing feel runs ~150 micron (~300 GSM-equivalent at 2.0 g/cm³ density) — i.e. matched by stiffness, not by weight.*

| Metric | Wood-pulp A4 (80 GSM) | Stone paper A4 (150 micron / ~300 GSM-equiv, matched stiffness) | Stone paper A4 (80 GSM-equiv, matched weight — thinner/floppier, not commercially realistic) |
| :---- | :---- | :---- | :---- |
| Weight per sheet | 5.0 g | 18.75 g | 5.0 g |
| Sheets per kg | 200 | 53 | 200 |
| Material cost/sheet at *production cost* (₹42,000–73,000/t wood; ₹24,000–32,000/t stone) | ₹0.21–0.37 | ₹0.45–0.60 | ₹0.12–0.16 |
| Material cost/sheet at *wholesale sell price* (₹45,000–55,000/t wood writing-grade; ₹60,000–108,000/t stone) | ₹0.23–0.28 | ₹1.13–2.03 | ₹0.30–0.54 |
| Cost per ream (500 sheets), production cost | ₹105–185 | ₹225–300 | ₹60–80 |
...
| :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| A0 | 1.000 | 80.0 | 4.60 | 300.0 | 8.40 | 1.8x |
| A1 | 0.500 | 40.0 | 2.30 | 150.0 | 4.20 | 1.8x |
| A2 | 0.250 | 20.0 | 1.15 | 75.0 | 2.10 | 1.8x |
| A3 | 0.125 | 10.0 | 0.58 | 37.5 | 1.05 | 1.8x |
| A4 | 0.0625 | 5.0 | 0.29 | 18.75 | 0.53 | 1.8x |
| A5 | 0.03125 | 2.5 | 0.14 | 9.375 | 0.26 | 1.8x |
| A6 | 0.015625 | 1.25 | 0.07 | 4.6875 | 0.13 | 1.8x |
| Letter | 0.0603 | 4.82 | 0.28 | 18.09 | 0.51 | 1.8x |
| Legal | 0.0769 | 6.15 | 0.35 | 23.07 | 0.65 | 1.8x |

*The 1.8x premium ratio is constant across sizes by construction (it's purely area × GSM × price-per-tonne, all linear) — the only thing that changes between rows is scale. Real-world premiums will vary from this because of the wholesale-vs-production-cost gap shown in §18.1.2, and because a real converter quote bundles in conversion, print, and margin on top of substrate cost.*
...
| :---: | :---- | :---- | :---- | :---- | :---- | :---- |
| <img src="images/skus/notebook.png" width="130"> | Hardcover notebook (Karst, global DTC) | A5 (148×210mm) | ~192pg | US $28.95–35.00 (≈₹2,450–2,960) | Premium conventional hardcover notebook (Moleskine-tier), ≈US $18–25 | Comparable — competes as eco-premium vs. premium, not vs. cheap |
| <img src="images/skus/notebook-softcover.png" width="130"> | Softcover notebook (Karst) | A5 (148×210mm) | ~192pg | US $26.95 (≈₹2,280) | Standard softcover conventional notebook, ≈US $10–20 | ~1.5–2.5x |
| <img src="images/skus/notebook.png" width="130"> | Pro Series notebook (Karst — same physical format as the hardcover row, premium finish/branding) | A5 (148×210mm) | Professional grade | US $44.95 (≈₹3,800) | — | — |
| <img src="images/skus/notebook-open-ruled.png" width="130"> | Stone paper ruled notebook, India (Amazon, general market) | A5/A6 (148×210mm / 105×148mm) | 172–200pg ruled | ₹236–498 post-discount (MRP ₹500–1,499) | Classmate/Navneet-tier ruled notebook, 172–200pg, ₹40–150 | **~2–5x retail**, even post-discount |
...
| :---- | :---- | :---- |
| Water-based offset/flexo ink | Absorbs normally — standard process | **Does not absorb** — the sheet has no fibre pores; ink sits on the surface and won't dry/set on its own |
| UV-curable offset/flexo ink | Works, less commonly needed | **Required for most commercial stone paper printing** — ink is cured by UV light rather than absorbed, since the polymer surface won't take conventional ink |
| Laser printing/toner | Standard, no caveat | Generally works (toner fuses to the surface rather than absorbing) — **but the HDPE component softens around 120–130°C, and some laser fuser units run hotter; high-heat or double-sided settings on some printers can warp or jam stone paper.** Confirm printer compatibility before bulk laser use, don't assume parity with paper |
| Inkjet (water-based) | Standard | Poor — ink beads/smears without fibre absorption; not a recommended method |
...
| Image | Carton type | What it is | Typical size (illustrative) | Conventional material/GSM | Stone paper fit |
| :---: | :---- | :---- | :---- | :---- | :---- |
| <img src="images/skus/carton.png" width="130"> | Folding carton (reverse/straight tuck) | Pharma secondary packaging, small consumer-goods boxes | ~100×150×40mm blank (pharma strip-pack scale) | Folding Box Board (FBB)/SBS, 250–350 GSM (~0.3–0.4mm) | **Good fit** — stone paper's native 0.1–0.4mm range matches this stock directly; moisture resistance is the selling point pharma buyers already want |
| <img src="images/skus/carton-rigid.png" width="130"> | Rigid/set-up box | Premium retail packaging (gifting, electronics) | Highly variable — sized to the product, not a standard blank | Chipboard core wrapped in printed paper, effectively 800+ GSM combined | **Weak fit as the structure, good fit as the wrap** — stone paper alone at 0.4mm max thickness doesn't reach rigid-box stiffness. But the printed wrap and inner liner over that core are 120–157 GSM sheet, which is squarely in range: costed in full at **§18.9.3** |
| <img src="images/skus/carton-corrugated.png" width="130"> | Corrugated board (fluting + liner) | Shipping cartons, e-commerce outer boxes | Standard e-commerce sizes, e.g. ~230×160×90mm | Fluting medium 100–180 GSM + linerboard 150–300 GSM per ply | **Poor fit for the fluted layer** — corrugating requires a fibre that can be creased into a flute profile without cracking; stone paper's polymer content resists this. Realistic use is as a **printed liner/facing layer** laminated onto conventional corrugated board, not as a replacement for the whole structure |
| <img src="images/skus/carton-mono.png" width="130"> | Mono-carton (single-wall, non-corrugated) | Cosmetics, small pharma units, food-adjacent (non-direct-contact) | ~80×50×120mm (small cosmetic/pharma unit carton) | Kraft/duplex board, 250–400 GSM | **Good fit** — same logic as folding cartons; this is the realistic entry SKU |
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| Folding carton | 300 GSM | 18 g | ₹1.04 | ₹0.50 | Moisture resistance native to stone paper vs. an added coating step for wood-pulp board |
| Corrugated — liner/facing layer only | 200 GSM (single liner ply, not the full fluted board) | 12 g | ₹0.69 | ₹0.34 | This costs only the printed liner stone paper would realistically supply, not the fluted core beneath it |
| Mono-carton | 325 GSM | 19.5 g | ₹1.12 | ₹0.55 | Same logic as folding carton, slightly heavier stock |
...
| :---: | :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| <img src="images/skus/label-adhesive.png" width="130"> | Self-adhesive labels (pressure-sensitive) | ~100×150mm face (0.015 m²) | Face stock 60–90 GSM + adhesive + release liner | ₹0.06 (at 75 GSM mid-range) | ₹0.03 | Paper face stock (absorbs moisture, tears) or PVC/PP synthetic face stock (petroleum-based) | Waterproof + tear-resistant natively, tree-free alternative to PVC/PP — direct competitive angle against synthetic-paper incumbents, not ordinary paper labels |
| <img src="images/skus/tag-hang.png" width="130"> | Hang tags (garment/footwear) | ~40×80mm (0.0032 m²) | 180–300 GSM rigid stock | ₹0.05 (at 250 GSM mid-range) | ₹0.02 | Kraft/card tag stock | Adidas's global use of stone-paper shoe hang tags ([13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md) §13.7) is a proven, exportable use case — good stiffness match at stone paper's higher end (0.3–0.4mm) |
| <img src="images/skus/label-menu.png" width="130"> | Menus / placemats | ~A4, 210×297mm (0.0625 m²) | 200–250 GSM, laminated for wipe-clean use | ₹0.81 (at 225 GSM mid-range) | ₹0.39 | Paper + plastic lamination | Native waterproof/wipe-clean property removes the lamination step entirely |
| <img src="images/skus/label-idcard.png" width="130"> | ID/access cards | ISO/IEC 7810 ID-1, 85.6×54mm (0.0046 m²) | Rigid, ~0.76mm (standard "CR80" card thickness) | Not costed — incumbent is PVC, not wood-pulp paper; no project-sourced PVC ₹/tonne figure | Substrate-only estimate ≈₹0.20 at 0.76mm/~1,520 GSM-equivalent, production cost — **card-grade stiffness at this thickness is unverified for stone paper**, treat as a rough floor only | PVC card | Direct plastic-alternative angle in principle; PVC cards are a mature, very cheap, thin incumbent — a harder displacement than labels/tags, and the property-match case is weaker here than elsewhere in this table |
| <img src="images/skus/label-signage.png" width="130"> | Outdoor signage / banners | ~600×900mm panel (0.54 m²) | Thick sheet, 0.3–0.4mm+ | Not costed — incumbent is corrugated plastic (Correx/Coroplast) or vinyl, not wood-pulp paper; no project-sourced ₹/tonne figure for either | ≈₹10.58 at 0.35mm/700 GSM-equivalent, production cost | Corrugated plastic (Correx/Coroplast) or vinyl banner | Waterproof/UV-exposed use case fits stone paper's core property set well; direct cost comparison depends on a real corflute/vinyl quote, not available in this research pass |
...
| Image | Type | Typical construction | Conventional GSM/thickness | Stone paper fit |
| :---: | :---- | :---- | :---- | :---- |
| <img src="images/skus/wallpaper.png" width="130"> | Non-woven wallpaper (most common modern type) | Cellulose/synthetic-fibre non-woven base, printed, sometimes lightly coated | 150–250 GSM | Weak fit as a direct substitute — non-woven's "paste the wall" installation method relies on backing porosity to breathe and release; a dense polymer/mineral composite doesn't behave the same way on a wall |
| <img src="images/skus/wallpaper-vinyl-coated.png" width="130"> | Vinyl-coated paper wallpaper | Paper base + PVC coating for wipeability | 200–300 GSM base + coating | **Closer fit** — stone paper is effectively "pre-coated" for water resistance, so it could replace the paper-base-plus-coating construction in one layer, if adhesion/installation (§18.6.4) is solved |
| <img src="images/skus/wallpaper-solid-vinyl.png" width="130"> | Solid vinyl/PVC wallpaper | Full PVC sheet, sometimes fabric-backed | 300–500+ GSM equivalent | Closest functional match — both are polymer-heavy and waterproof, used in the same wet-area use case; stone paper's pitch here is "lower-plastic-fraction, marble-waste-diverted alternative to 100% PVC," not a cost play |
| <img src="images/skus/wallpaper-peel-stick.png" width="130"> | Peel-and-stick (self-adhesive) wallpaper | Printed film + pre-applied adhesive backing + release liner | Vinyl/polymer film, no wet paste needed | **Best installation-method match** — see §18.6.4; sidesteps the wet-paste-adhesion problem entirely by design |
| <img src="images/skus/wallpaper-textured.png" width="130"> | Textured/embossed (3D foam) wallpaper | Foamed PVC or flocked paper | Variable, often 400+ GSM equivalent | Not a good fit — stone paper's calendered/compounded process doesn't produce the foamed/embossed texture this category depends on, without added tooling |
...
| :---- | :---- | :---- |
| Rotogravure (mass-market, high-volume runs) | Water-based or solvent-based ink, absorbed into the fibre/coating | **No, not without a process change** — same root issue as §18.3: stone paper's surface doesn't absorb ink, and gravure cylinders are engraved per-pattern, expensive to requalify for a different ink chemistry |
...
| :---- | :---- | :---- | :---- |
| Budget non-woven wallpaper (imported, basic pattern) | ₹1,300–2,700 | ₹250–500 | Largest volume segment in India today |
| Mid/premium non-woven (Asian Paints Nilaya, Marshalls-tier) | ₹2,700–8,000+ | ₹500–1,500+ | Brand and design-led pricing, not substrate-cost-led |
| Solid vinyl/PVC wallpaper | ₹2,000–5,000 | ₹380–950 | Closest existing category to a stone-paper wallpaper's physical profile |
| Peel-and-stick vinyl wallpaper | ₹3,000–7,000 | ₹570–1,320 | Growing DIY segment, and the installation format §18.6.4 flags as the realistic fit |
| **Stone paper wallpaper — cost-derived estimate, not a market price** | — | Production cost at 300 GSM-equivalent (0.15mm), midpoint ₹28,000/t: **≈₹8.40/m²** substrate-only, before adhesive lamination, printing and converting | Substrate cost alone sits *below* every conventional retail category above — but retail wallpaper pricing is overwhelmingly design/brand-driven, not substrate-cost-driven (same dynamic already established for stone-paper notebooks in §18.2), so this gap says little about achievable retail pricing on its own |
...
| Dimension | Read |
| :---- | :---- |
| Property fit | Strong — waterproof/mold-resistant natively addresses a real, common Indian wallpaper failure mode |
| Printing fit | Conditional — incompatible with mass-market gravure, genuinely compatible with the growing digital/custom UV-print niche |
| Installation fit | Conditional — wet-paste non-woven format doesn't work; peel-and-stick very likely does, but needs a new adhesive-lamination step not yet budgeted anywhere in this plan |
| Cost fit | Favorable at substrate level, unproven at retail (design/brand drives wallpaper retail pricing, not raw material) |
| Research maturity | **Lowest of any segment in this catalog** — no project-sourced market sizing, competitor, or certification data exists yet; treat as a segment worth a scoping call to 2–3 Indian wallpaper distributors/printers before committing any capex or converting-line design to it |
...
| :---: | :---- | :---- | :---- | :---- | :---- | :---- |
| <img src="images/skus/mailer.png" width="130"> | Padded/kraft mailer envelope | ~250×350mm (0.0875 m²) | Kraft paper, 70–90 GSM, sometimes poly-lined | ₹0.40 (at 80 GSM mid-range) | ₹0.20 | Waterproof property removes the poly-lining need; pitch on tactile/brand story to premium D2C, not on price — and note the substrate cost is favorable here too, same dynamic as cartons in §18.4 |
| <img src="images/skus/mailer-poly.png" width="130"> | Poly mailer (the actual incumbent at scale) | Standard e-commerce sizes | HDPE/LDPE film, ₹1.30–6/piece (project-sourced, [13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md) §13.7) | — | Stone paper cannot win this fight on cost — the poly mailer's own sourced price undercuts even the derived kraft-mailer figures above | Don't target this SKU as a volume replacement |
...
| :---: | :---- | :---- | :---- | :---- | :---- | :---- |
| <img src="images/skus/bag-carry-boutique.png" width="130"> | Boutique / jewellery bag | 180×230×90mm | 0.174 m² | **₹2.34** | ₹2.94 (₹2.50 + ₹0.44 film) | Cheaper, and one material instead of two |
| <img src="images/skus/bag-carry-premium.png" width="130"> | Retail standard carry bag | 320×250×120mm | 0.315 m² | **₹4.23** | ₹5.33 (₹4.52 + ₹0.80 film) | The reference size — apparel, footwear, D2C |
| <img src="images/skus/bag-carry-premium.png" width="130"> | Bridal / large gift bag | 400×320×150mm | 0.487 m² | **₹6.55** | ₹8.25 (₹7.00 + ₹1.24 film) | Highest ticket; wedding/festive seasonality |
...
| :---- | :---- | :---- | :---- |
| Greyboard core (1.5mm) | **Bought in — not us**, identical on both sides | ₹4.43 | ₹4.43 |
...
## 18.10 Master Property Comparison — Stone Paper vs. Wood-Pulp Paper

*Consolidates property data already established across [03_Unit_Economics.md](03_Unit_Economics.md), [13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md) and [16_Process_Environmental_Profile.md](16_Process_Environmental_Profile.md) into one reference table.*

| Property | Wood-pulp paper | Stone paper | Source |
| :---- | :---- | :---- | :---- |
| Primary input | Wood pulp/recycled fibre | ~80% ground CaCO₃, ~18% HDPE, ~2% additive | [16_Process_Environmental_Profile.md](16_Process_Environmental_Profile.md) §16 intro |
| Density | ~0.7–0.9 g/cm³ | ~2.0 g/cm³ (derived) | §18.0 above |
| Water use in production | ~200 tonnes/tonne output | ~0 | [03_Unit_Economics.md](03_Unit_Economics.md) §4.4 |
| Energy use in production | ~2,908 kWh/tonne | ~700 kWh/tonne (76% less) | [03_Unit_Economics.md](03_Unit_Economics.md) §4.4 |
| Waterproof | No (needs coating/lamination) | Yes, natively | [01_Core_Idea_Pitch_Summary.md](01_Core_Idea_Pitch_Summary.md) §2 |
| Tear resistance | Standard | Higher, natively | [01_Core_Idea_Pitch_Summary.md](01_Core_Idea_Pitch_Summary.md) §2 |
| Standard printing (water-based offset/inkjet) | Yes | No — needs UV-curable ink or specific process | §18.3 above |
| Mass-market gravure printing (the wallpaper industry's default) | Yes | No — same ink-absorption gap as above; digital UV/latex printing is the compatible route instead | §18.6.3 above |
| Biodegradable | Yes | **No** — HDPE fraction only photodegrades over 14–18 months into CaCO₃ + microplastic fragments | [16_Process_Environmental_Profile.md](16_Process_Environmental_Profile.md) §16.4 |
| Recyclable in existing India infrastructure | Yes, established streams | **No** — mixed mineral/polymer composite fouls both paper and plastic recycling streams | [16_Process_Environmental_Profile.md](16_Process_Environmental_Profile.md) §16.4 |
| Compostable-binder alternative available | N/A | PBAT swap is the realistic near-term fix (~12–15% cost premium), true PBS priced out of reach domestically | [16_Process_Environmental_Profile.md](16_Process_Environmental_Profile.md) §16.6 |
| Feedstock sourcing story | Virgin/recycled wood fibre | Rajasthan marble-slurry waste diversion — pollution liability turned input | [16_Process_Environmental_Profile.md](16_Process_Environmental_Profile.md) §16.5 |
| GST/HSN classification | Established (Chapter 48, 5–12%) | **Unresolved** — could fall under Chapter 48 (paper), HSN 3921 (plastic sheet, 18%), or Chapter 68 (stone articles); needs a formal advance ruling | [13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md) §13.6 |
| Production cost/tonne (materials+energy) | ₹42,000–73,000+ | ₹24,000–32,000 | [03_Unit_Economics.md](03_Unit_Economics.md) §4.6.1 |
| Wholesale market price/tonne | ₹32,500–55,000 (kraft to writing/print grade) | ₹60,000–108,000+ | [13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md) §13.4 |
| Retail finished-goods premium | Baseline | 2–5x (notebooks), ~2–3x per-kg (packaging) | [13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md) §13.4.2 |

---

## 18.11 Cost Roll-Up — All SKU Categories at a Glance

| Category | Stone paper positioning vs. wood-pulp | Cost verdict | Priority |
| :---- | :---- | :---- | :---- |
| Loose sheet/copier paper (A4 etc.) | Not a realistic SKU — matched-stiffness cost runs 2–7x wood-pulp | Losing | Not recommended |
| Notebooks/stationery (converted) | Sells at 2–5x retail premium on brand/ESG grounds, not cost | Winning, on positioning not cost | **#1 — lead with this** (per [13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md) §13.7) |
| Pharma secondary cartons | Cheaper at matched-GSM production cost; native moisture resistance saves a coating step | Winning, structurally | **#2 — parallel priority** (§13.7) |
| Industrial labels/tags/signage | Best margin-per-tonne identified; property match is the whole sale | Winning, on differentiation | **#3 — parallel priority** (§13.7) |
| E-commerce mailers | Poly mailers are structurally cheaper; approach premium brands only, not marketplace scale | Losing on cost, viable on brand niche | #4 — selective only (§13.7) |
| Government/institutional | Real tailwinds (GeM green procurement) but no confirmed near-term mandate | Undetermined | #5 — build toward (§13.7) |
| Food packaging (grease-resistant) | Certification gate (FSSAI/HDPE food contact) unresolved | Undetermined | #6 — deprioritize initially (§13.7) |
| Wallpaper (wall coverings) | Substrate cost favorable, but printing/installation need a different process (digital UV print + adhesive lamination, not gravure + wet paste) than any other SKU here | Favorable at substrate level, unproven at retail | **Not project-researched — scope with 2–3 distributors before committing capex** (§18.6) |
| Premium carry bags | ~20% below the *laminated* incumbent at production cost, and one material instead of paper + BOPP film. Substrate is under a fifth of a finished bag's price, so this is won on property and story, not on cost | Favorable, but not the deciding factor | **Expansion horizon — gate on the glue/foil trials in §18.9.4**, target Indian premium retail, not European luxury (§18.9) |
| Rigid/set-up boxes (wrap + liner only) | Cannot be the structure at any gauge we make; supplies ~25% of box material value as the visible decorative layer, at half the laminated-paper cost | Favorable on the layer we actually supply | **Expansion horizon — scope alongside carry bags; same buyer, same trials** (§18.9.3) |

---

## Next

* Full unit-economics derivation these SKU costs are built from → [03_Unit_Economics.md](03_Unit_Economics.md)
* The market-pricing and sector-priority research behind §18.4–18.5, §18.7–18.8 → [13_Paper_Industry_Economics_Deep_Dive.md](13_Paper_Industry_Economics_Deep_Dive.md)
* Biodegradability/end-of-life caveats behind every "stone paper wins" property claim → [16_Process_Environmental_Profile.md](16_Process_Environmental_Profile.md)
* Converting-line capacity and cost this catalog assumes → [17_Factory_Operations_Plan.md](17_Factory_Operations_Plan.md) §17.2.2
